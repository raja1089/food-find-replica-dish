...
async function simpleSeed() {
  try {
    console.log("🌱 Seeding MySQL database (simple)...");
    ...
    // Create footer pages (without emojis)
    await db.insert(footerPages).values([
      {
        title: "Privacy Policy",
        slug: "privacy-policy",
        content: "<h1>Privacy Policy</h1><p>This Privacy Policy describes how QOOKKAR collects, uses, and protects your personal information when you use our food delivery platform.</p>",
        category: "legal",
        isPublished: true,
        order: 1
      },
      {
        ...
        content: "<h1>Terms and Conditions</h1><p>These Terms and Conditions govern your use of the QOOKKAR platform and services.</p>",
        category: "legal",
        isPublished: true,
        order: 2
      },
      {
        title: "Contact Us",
        slug: "contact",
        content: "<h1>Contact Us</h1><p>We are here to help! Get in touch with us through any of the following methods.</p>",
        category: "support",
        isPublished: true,
        order: 3
      }
